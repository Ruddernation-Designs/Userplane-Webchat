...
<head>
	...
	<!--
		...
		{
			window.open( "userplane/wc.aspx", "UserplaneChatWindow", "width=500,height=400,toolbar=0,directories=0,menubar=0,status=0,location=0,scrollbars=0,resizable=1" );
		}
	//-->
	</script>
</head>
...
<body>
	...
	<!--#include virtual="userplane/wc.aspx"-->
